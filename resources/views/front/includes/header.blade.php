        ...
        <div class="pull-right hidden-mobile">
            <address class="contact-details">
                <span class="contact-phone">
                    <i class="soap-icon-phone"></i> {{\Facades\App\Helper\IceHelper::getSetting('Phone')}}
                </span>
            </address>
        </div>
    ...
    <div class="main-navigation">
        <div class="container">
                ...
                <ul class="menu">
                    ...
                    @foreach($categories as $cat)
                        @if($cat->category_id == null)
                            <li class="menu-item-has-children">
                                <a href="{{ url('home/'.$cat->url_slug)}}">{{$cat->title}}</a>
                                <ul>
                                    @foreach($categories as $subcat)
                                        @if($cat->id == $subcat->category_id)
                                            <li><a href="{{ url('home/'.$cat->url_slug.'/'.$subcat->url_slug)}}">{{$subcat->title}}</a></li>
                                        @endif
                                    @endforeach
                                </ul>
                            </li>
            ...
            <ul class="social-icons clearfix pull-right hidden-mobile">
                <li class="twitter"><a title="twitter" href="{{\Facades\App\Helper\IceHelper::getSetting('Twitter')}}" data-toggle="tooltip"><i class="soap-icon-twitter"></i></a>
                </li>
                <li class="facebook"><a title="facebook" href="{{\Facades\App\Helper\IceHelper::getSetting('Facebook')}}" data-toggle="tooltip"><i
                                class="soap-icon-facebook"></i></a></li>
                <li class="linkedin"><a title="linkedin" href="{{\Facades\App\Helper\IceHelper::getSetting('LinkedIn')}}" data-toggle="tooltip"><i
                                class="soap-icon-linkedin"></i></a></li>
                <li class="vimeo"><a title="vimeo" href="{{\Facades\App\Helper\IceHelper::getSetting('Vimeo')}}" data-toggle="tooltip"><i class="soap-icon-vimeo"></i></a>
                </li>
            </ul>
        </div>
    </div>
